/* ============================================
   ...
   ⚠ 本页已废弃(2026-09-22):分拣项写死为系统内置后不再提供配置与维护,
   功能清单里已移除本页(不开发),只读清单仅作字段口径参考,便于对照历史方案。
...
document.getElementById('app').innerHTML = Layout.window({
  ...
  content: `
    <div class="deprecated-bar">⚠ 本页已废弃(2026-09-22):分拣项改为系统内置,不再提供新增/编辑等维护能力——新增分拣维度须开发在过机接口补取值后登记;规则配置的「验证字段」下拉即本清单。下方内容仅作字段口径参考,不开发。</div>
